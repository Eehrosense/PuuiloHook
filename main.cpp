...
int main()
{
	...
	std::printf(
	"PuuiloHook External for CS2\n"
	"Author: Eehro\n"
	"Source Code: https://github.com/Eehrosense/PuuiloHook\n"
	"\n"
	"- These features may result in VAC Bans, use at your own risk:\n"
	"	* Bhop, NoFlash, Glow\n"
